 ...
 * простое нестандартное представление
 */
...
// Фон закрашивается серовато-белым цветом
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mCurrentBox != null) {
                    ...
                    //заставляет BoxDrawingView перерисовать себя,
                    // чтобы пользователь видел прямоугольник
    ...
    /*
    переопределение для того, чтобы вмешаться в процесс прорисовки
     */
    @Override
